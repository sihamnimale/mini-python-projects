...
type_input = input("Enter the type of food you want to order: ").lower()
display_available_meals(type_input)
name_input = input("Enter the name of the meal you want to order: ").capitalize()
amount_input = int(input("Enter the amount you want to order: "))
